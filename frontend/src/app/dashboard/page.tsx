                    ...
                    {result ? (
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {contest.results_released && (
                          <Button variant="outline" onClick={() => router.push(`/student-review?contest=${contest.id}`)}>
                            Review marked paper
                          </Button>
                        )}
                      </div>
                    ) : live && paid ? (
                      <Button size="lg" icon={<Play size={16} />} onClick={() => router.push(`/exam?contest_id=${contest.id}`)}>

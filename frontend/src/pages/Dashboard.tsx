                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      <h3 className="font-bold text-foreground text-lg">{contest.name}</h3>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      {result ? (
                        ...
                        <p className="text-sm text-muted mt-1">The contest is live. {hasDraft ? "Your draft is saved — resume anytime." : "Ready when you are."}</p>
                      ) : live && !paid ? (
